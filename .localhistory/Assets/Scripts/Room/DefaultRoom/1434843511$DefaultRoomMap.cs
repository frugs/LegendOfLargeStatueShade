...
namespace Assets.Scripts.Room.DefaultRoom {
    public class DefaultRoomMap {
        ...
        private static readonly Id<IRoom> Room1Id = new Id<IDoor>(new GUID("9d7272d1-535a-44b4-a732-a943929f9a48"));
        private static readonly Id<IRoom> Room2Id = new Id<IDoor>(new GUID("a3aa9d93-2560-48ce-9cb3-306ff8b1b91e"));
